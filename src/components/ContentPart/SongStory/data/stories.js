export default [
  ...
  },
  {
    ...
    Это независимый лейбл из Бостона, который выпускал релизы Modern Baseball, Citizen, Makthaverskan, Tigers Jaw, Basement и кучи других крутых групп</p>`,
  ...
  },
  {
    ...
    albumName: 'On The Impossible Past',
    quoteTextEn: 'You cut my hair, you left red ink everywhere<br>Do my hands tell a story? Is it boring?',
    quoteTextRu: 'Ты срезала мои волосы, ты внесла правки во всё<br>Можешь ли ты читать по рукам? Это скучная история?',
    story: `
  ...
  },
  {
    ...
    albumName: 'On The Impossible Past',
    quoteTextEn: 'And I once held your words close to my heart<br>With a knife protecting all of them',
  ...
  },
  {
    ...
    albumName: 'Rented World',
    quoteTextEn: 'I am a tiny fly, buzzing around in a field<br>Somewhere in the overgrowth of your memory',
  ...
  },
  {
    ...
    Имя "Ричард Кори" взято из <a class="link" href="http://www.uspoetry.ru/poem/123" target="_blank">стихотворения</a> Эдвина Арлингтона Робинсона, написанного после <a class="link" href="" target="_blank">"Паники&nbsp;1893&nbsp;года"</a> - худшего экономического кризиса в истории США на тот момент.
    ...
    Ошибка в фамилии, Coury вместо Cory, сознательна и типична для группы, чьё название искаженное немецкое слово minnesänger - менестрели. 
